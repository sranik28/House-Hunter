...
const router = createBrowserRouter([
    {
      ...
      children: [
        ...
        },
        {
          path: "/booking/:id",
          element: <BookingForm />,
          loader: ({params}) => fetch(`https://house-hunter-backend-caxj15ubr-sranik28.vercel.app/house/${params.id}`)
        },
        {
          path: "/signup",
          element: <Signup />,
        ...
        children: [
         ...
         // House Renter Dashboard
          ...
          },
          {
            ...
            loader: ({params}) => fetch(`https://house-hunter-backend-caxj15ubr-sranik28.vercel.app/getprofileinfo/${params.id}`)
          },
        ],
      },
  ]);
